...
import withAuthLoginLogout from "./withAuthLoginLogout";

const HocExercise = () => {
    const ComponentWithPropsStyle = withPropsStyles(SimpleComponent);
    const ComponentWithAuthLoginLogout = withAuthLoginLogout(
